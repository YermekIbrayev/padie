...
@Entity
@Table(name = "selecteditemsaddtbl")
public class SelectedItemsAdd {
	private int id;
	private int pid;
	private Date created;
	private MainSelection additionalQID;
	...
	public MainSelection getAdditionalQID() {
		return additionalQID;
	}
	public void setAdditionalQID(MainSelection additionalQID) {
